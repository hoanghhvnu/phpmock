...
<script type="text/javascript" src="http://localhost/phpmock/js/jquery.js"></script>
<script src="http://www.modernizr.com/downloads/modernizr-latest.js"></script>
<script type="text/javascript" src="http://localhost/phpmock/js/placeholder.js"></script>
</head>
<body>
...
<label for="username">username</label><input type="text" name="txtUser" class="placeholder" placeholder="UserName">
<?php echo form_error('txtUser');?>
<label for="password">password</label><input type="password" name="txtPass" class="placeholder" placeholder="Password">
